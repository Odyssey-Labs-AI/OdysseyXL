...
### Odyssey Labs Community License
...
This Agreement is intended to allow research, non-commercial, and limited commercial uses of the Models free of charge. In order to ensure that certain limited commercial uses of the Models continue to be allowed, this Agreement  preserves free access to the Models for people or organizations  generating annual revenue of less than US $50,000 (or local currency equivalent).  
...
4. **Prohibited Uses**  
	   This software may **NOT** be used for:
		   1. **Fraudulent Activities:** Engaging in scams, misinformation, identity theft, or any other form of fraud.  
		   2. **NSFW Content:** Generating, distributing, or promoting explicit, obscene, or otherwise inappropriate content that violates community standards or applicable laws.  
		   3. **Cheating in Academic or Professional Settings:** Using the software to gain an unfair advantage in academic or professional assessments, including but not limited to generating answers, automating tasks meant to test personal knowledge, or bypassing plagiarism checks.
		   4. **Malicious Purposes:** Creating malware, conducting cyberattacks, hacking, or any activities that harm individuals, organizations, or systems.  
		   5. **Hate Speech or Discrimination:** Promoting violence, hate, discrimination, or harassment based on race, gender, religion, ethnicity, or any other factor.  
		   6. **Violations of Privacy:** Collecting or using personal data without proper consent or in violation of privacy laws.
---
5. **Attribution**  
	   The following conditions apply:
		   - Any use of this software must include a clear acknowledgment of both **Odyssey Labs** and **Stability AI** in all copies or substantial portions of the software. 
		   - If this software is modified and redistributed, the modifications must be documented, and attribution to **Odyssey Labs** and **Stability AI** must still be maintained.
